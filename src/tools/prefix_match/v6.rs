...
pub struct Ipv6PrefixMatcher {
    ...
    prefix_val:Vec<AHashMap<u128, u16>>,
...
impl Ipv6PrefixMatcher {
    ...
    pub fn new(path: String, default_granularity:u8, prefix_len_limit_str:&str) -> Self {
        ...
        let mut matcher = Self {
            ...
            prefix_val: vec![],
            len:0,
            default_move_len:128-default_granularity,
        };
    ...
    fn add_net_from_ip_mask(&mut self, ip:Ipv6Addr, mask:u8, asn:u16){
    ...
    #[allow(dead_code)]
    pub fn get_asn(&self, ip_val:u128) -> Option<(u8, u128, u16)> {
    ...
    #[allow(dead_code)]
    pub fn get_asn_by_default_move_len(&self, ip_val:u128) -> (u8, u128, u16) {
