use crate::modules::target_iterators::cycle_group::cycle_group_with_port::cycle_group_ipv4::CycleIpv4Port;
...
impl CycleIpv4Port {
    ...
    #[inline]
    fn parse_tar_val(&self, tar_val:u64) -> (bool, u32, u16) {
        ...
        if port_val < self.tar_port_num {
            ...
            let real_ip = self.start_ip + (ip_val as u32);
...
impl Ipv4IterP for CycleIpv4Port {
