...
use crate::tools::check_duplicates::bit_map::{BitMapV6, BitMapV6Port};
...
impl ModeMethod for CycleV6 {
    ...
    fn execute(&self){
        ...
        if let Ok(receiver_info) = receiver_res.join() {
            ...
            write_to_summary!(self; "CycleV6"; "result";
